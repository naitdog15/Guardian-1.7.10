...
import com.guardian.extenders.AxisAlignedBBExtender;
import com.guardian.extenders.GlStateManager;
import com.guardian.extenders.RenderLivingExtender;
import com.guardian.extenders.TessellatorExtender;
import com.guardian.extenders.WorldRenderExtender;
...
public class RenderGuardian extends RenderLiving {
	...
	private static final ResourceLocation GUARDIAN_TEXTURE = new ResourceLocation(Guardian.modid + ":textures/entity/guardian.png");
    private static final ResourceLocation GUARDIAN_ELDER_TEXTURE = new ResourceLocation(Guardian.modid + ":textures/entity/guardian_elder.png");
    private static final ResourceLocation GUARDIAN_BEAM_TEXTURE = new ResourceLocation(Guardian.modid + ":textures/entity/guardian_beam.png");
    ...
    int field_177115_a;
	    ...
	    public RenderGuardian(ModelGuardian modelGuardian) 
	    { 
		...
		public void doRender(EntityGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
	    {
	        ...
	        if (entitylivingbase != null)
	        {
	            ...
	            Tessellator tessellator = TessellatorExtender.getInstance();
