...
public class VertexFormatElement {
    ...
    private final boolean bound(int p_177372_1_, VertexFormatElement.EnumUsage p_177372_2_)
    {
    ...
    public static enum EnumUsage
    {
        ...
        public void preDraw(EnumUsage attrType, VertexFormatElement format, int element, int stride, java.nio.ByteBuffer buffer) {
            ...
            switch(attrType)
            {
                ...
                case PADDING:
                    break;
                case GENERIC:
                    gl2.glDisableVertexAttribArray(attr.getIndex());
                default:
                    FMLLog.severe("Unimplemented vanilla attribute upload: %s", attrType.getDisplayName());
            }
        	
		}
        public void postDraw(EnumUsage attrType, VertexFormatElement format, int element, int stride, java.nio.ByteBuffer buffer) {
        	VertexFormatElement attr = format.getElement(element);
        	GL11 gl = null;
           	GL20 gl2 = null;
            switch(attrType)
...
public int func_181720_d(int vertexFormatIndex) {
	// TODO Auto-generated method stub
	return ((Integer)this.offsets.get(vertexFormatIndex)).intValue();
}
